...
-- Exportiere Daten aus Tabelle core.admin_menus: ~21 rows (ungefähr)
...
INSERT INTO `admin_menus` (`ID`, `menu`, `parent`, `route_id`, `order`, `icon`) VALUES
	...
	(4, 'Kategorien', 3, 58, 12, 'fa-caret-right'),
	(5, 'Benutzer', 1, 5, 5, 'fa-caret-right'),
	(6, 'Rollen', 1, 6, 6, 'fa-caret-right'),
	(7, 'Seitenverwaltung', 0, 9, 1, 'fa-caret-right'),
	(8, 'Seiten', 7, 10, 17, 'fa-caret-right'),
	(9, 'Bereiche', 7, 11, 18, 'fa-caret-right'),
	(10, 'Artikel', 3, 61, 7, 'fa-caret-right'),
	(11, 'Artikeleinheiten', 3, 66, 13, 'fa-caret-right'),
	(12, 'Hersteller', 3, 69, 10, 'fa-caret-right'),
	(13, 'Lieferanten', 3, 71, 11, 'fa-caret-right'),
	(14, 'Lagerverwaltung', 3, 73, 14, 'fa-caret-right'),
	(15, 'Steuersätze', 3, 75, 15, 'fa-caret-right'),
	(16, 'Rich Cards/Snippets', 0, 80, 4, 'fa-caret-right'),
	(17, 'Kontakt', 16, 81, 19, 'fa-caret-right'),
	(18, 'Bestellungen', 3, 94, 9, 'fa-caret-right'),
	(19, 'Sonderpreisarten', 3, 99, 16, 'fa-caret-right'),
	(20, 'Variationen', 3, 108, 8, 'fa-caret-right'),
	(21, 'Gruppen', 20, 110, 20, 'fa-caret-right');
...
-- Exportiere Daten aus Tabelle core.auth_rights: ~815 rows (ungefähr)
...
-- Exportiere Daten aus Tabelle core.errors: ~19 rows (ungefähr)
DELETE FROM `errors`;
/*!40000 ALTER TABLE `errors` DISABLE KEYS */;
INSERT INTO `errors` (`ID`, `error_id`, `response_code`, `type`, `message`) VALUES
	(1, 0, 500, 'system', 'Unbekannter Fehler.'),
	(2, 1, 401, 'auth', 'Sie haben hierfür nicht genügend Rechte.'),
	(3, 2, 503, 'mail', 'Fehler während des Mailversands.'),
	(4, 3, 406, 'request', 'Ungültige Werte. Btte prüfen Sie Ihre Eingaben.'),
	(5, 4, 404, 'request', 'Keine Daten vorhanden.'),
	(6, 5, 501, 'system', 'Steht noch nicht zur Verfügung.'),
	(7, 6, 402, 'payment', 'Ungültige Zahlungsdaten.'),
	(8, 7, 429, 'payment', 'Zuviele Anfragen. Bitte gedulden Sie sich einen Moment.'),
	(9, 8, 410, 'auth', 'Verbindung verloren. Bitte melden Sie sich neu an.'),
	(10, 9, 404, 'mysql', 'Fehler während des Löschens.'),
	(11, 10, 404, 'mysql', 'Ungültige Daten.'),
	(12, 11, 404, 'mysql', 'Keine Daten vorhanden.'),
	(13, 12, 404, 'mysql', 'Doppelter Datensatz.'),
	(14, 13, 404, 'mysql', 'Syntaxfehler.'),
	(15, 14, 404, 'mysql', 'Datensatz konnte nicht angelegt werden.'),
	(16, 15, 404, 'mysql', 'Datensatz konnte nicht aktualisiert werden.'),
	(17, 16, 403, 'auth', 'Nicht erlaubt.'),
	(18, 17, 410, 'auth', 'Sitzung verloren.'),
	(19, 18, 404, 'mysql', 'Unbekanntes Modelattribut');
...
-- Exportiere Daten aus Tabelle core.models: ~50 rows (ungefähr)
DELETE FROM `models`;
...
-- Exportiere Daten aus Tabelle core.model_definitions: ~304 rows (ungefähr)
...
INSERT INTO `model_definitions` (`ID`, `model_id`, `col`, `model_type`, `translatable`) VALUES
	...
	(7, 1, 'prename', 3, 0),
	(8, 1, 'group', 2, 0),
	(9, 1, 'group_name', 103, 0),
	(10, 2, 'customizable', 2, 0),
	(11, 2, 'deleted', 2, 0),
	(12, 2, 'enabled', 2, 0),
	(13, 2, 'force', 2, 0),
	(14, 2, 'layout', 3, 0),
	(15, 2, 'route', 3, 0),
	(16, 2, 'seo_description', 3, 0),
	(17, 2, 'seo_keywords', 3, 0),
	(18, 2, 'title', 3, 0),
	(19, 2, 'crawlable', 2, 0),
	(20, 2, 'seo_frequency', 2, 0),
	(21, 2, 'seo_priority', 2, 0),
	(22, 2, 'scope', 103, 0),
	(23, 2, 'scope_id', 2, 0),
	(24, 2, 'user', 103, 0),
	(25, 2, 'content', 106, 0),
	(26, 2, 'version', 102, 0),
	(27, 2, 'content_date', 103, 0),
	(28, 2, 'plugin_name', 103, 0),
	(29, 2, 'plugin_enabled', 102, 0),
	(30, 2, 'type', 103, 0),
	(31, 2, 'content_enabled', 102, 0),
	(32, 3, 'name', 3, 0),
	(33, 4, 'group', 3, 0),
	(34, 5, 'email', 5, 0),
	(35, 5, 'password', 4, 0),
	(36, 5, 'confirmation_code', 3, 0),
	(37, 6, 'user_id', 2, 0),
	(38, 6, 'rsp_code', 2, 0),
	(39, 6, 'rsp_text', 3, 0),
	(40, 6, 'intenal_code', 2, 0),
	(43, 6, 'request', 3, 0),
	(44, 6, 'error_stack', 3, 0),
	(45, 7, 'name', 3, 0),
	(46, 8, 'menu', 3, 0),
	(47, 8, 'parent', 2, 0),
	(48, 8, 'route_id', 2, 0),
	...
	(72, 14, 'route', 103, 0),
	(73, 14, 'scope', 103, 0),
	(74, 15, 'content_id', 2, 0),
	(75, 15, 'content', 6, 0),
	(76, 15, 'version', 2, 0),
	(77, 15, 'user_id', 2, 0),
	(78, 15, 'type', 3, 0),
	(79, 15, 'plugin_enabled', 102, 0),
	(81, 16, 'version', 2, 0),
	(82, 16, 'route_id', 2, 0),
	(83, 16, 'page_content_id', 2, 0),
	(84, 16, 'enabled', 2, 0),
	(85, 17, 'plugin_name', 3, 0),
	(86, 17, 'plugin_enabled', 102, 0),
	(87, 17, 'plugin_admin_html', 106, 0),
	(88, 17, 'plugin_content', 108, 0),
	(89, 17, 'route_id', 102, 0),
	(90, 18, 'route_id', 2, 0),
	(91, 18, 'plugin_id', 2, 0),
	(92, 18, 'name', 103, 0),
	(93, 18, 'enabled', 2, 0),
	...
	(106, 101, 'name', 3, 0),
	(107, 101, 'value', 3, 0),
	(108, 101, 'article_id', 3, 0),
	(109, 102, 'KeyName', 3, 0),
	(110, 102, 'Sort', 2, 0),
	(111, 102, 'KeyKategorie', 2, 0),
	(112, 102, 'KeyOberkategorie', 2, 0),
	(113, 102, 'bookmark', 3, 0),
	(114, 102, 'image', 3, 0),
	(115, 103, 'KeyKategorie', 2, 0),
	(116, 103, 'KeyArtikel', 2, 0),
	(117, 104, 'KeyEigenschaft', 2, 0),
	(118, 104, 'KeyArtikel', 2, 0),
	(119, 104, 'Name', 3, 0),
	(120, 104, 'Sort', 2, 0),
	(121, 104, 'Waehlbar', 3, 0),
	(122, 105, 'KeyEigenschaft', 2, 0),
	(123, 105, 'Name', 3, 0),
	(124, 105, 'Aufpreis', 2, 0),
	(125, 105, 'Sort', 2, 0),
	(126, 105, 'Lager', 2, 0),
	(127, 105, 'ArtikelNr', 2, 0),
	(128, 105, 'Packeinheit', 2, 0),
	(129, 105, 'KeyEigenschaftWert', 2, 0),
	(130, 106, 'name', 3, 0),
	(131, 106, 'bookmark', 3, 0),
	(132, 106, 'stock', 2, 0),
	(133, 106, 'image', 3, 0),
	(134, 106, 'price', 2, 0),
	(135, 106, 'gross', 102, 0),
	(136, 106, 'tax', 2, 0),
	(137, 106, 'article_id', 3, 0),
	(138, 106, 'category_id', 2, 0),
	(139, 106, 'title', 6, 0),
	(140, 106, 'description', 6, 0),
	(141, 106, 'variations', 108, 0),
	(142, 106, 'rel_article_id', 3, 0),
	(143, 106, 'viewed', 2, 0),
	(144, 106, 'searched', 2, 0),
	(145, 106, 'rank', 102, 0),
	(146, 106, 'page', 102, 0),
	(147, 106, 'manufacturer', 103, 0),
	(148, 106, 'dependencies', 108, 0),
	(149, 106, 'publish_date', 7, 0),
	(150, 106, 'kind_of_new', 108, 0),
	(151, 107, 'Hersteller', 103, 0),
	(152, 107, 'amountArticles', 102, 0),
	(153, 108, 'order_id', 2, 0),
	(154, 108, 'article_id', 3, 0),
	(155, 108, 'amount', 2, 0),
	(156, 108, 'deleted', 2, 0),
	(157, 108, 'ref_article_id', 3, 0),
	(158, 108, 'price_brutto', 2, 0),
	(159, 108, 'tax', 2, 0),
	(160, 109, 'order_id', 2, 0),
	(161, 109, 'error', 3, 0),
	(162, 110, 'user_id', 2, 0),
	(163, 110, 'checkout_billing_id', 2, 0),
	(164, 111, 'user_id', 2, 0),
	(166, 111, 'company', 3, 0),
	(167, 111, 'ustid', 3, 0),
	(168, 112, 'user_id', 2, 0),
	...
	(173, 112, 'company', 3, 0),
	(174, 112, 'ustid', 3, 0),
	(175, 112, 'billing_country', 3, 0),
	(176, 112, 'billing_street', 3, 0),
	(177, 112, 'billing_postal', 3, 0),
	(178, 112, 'billing_city', 3, 0),
	(179, 112, 'shipping_country', 3, 0),
	(180, 112, 'shipping_street', 3, 0),
	(181, 112, 'shipping_postal', 3, 0),
	(182, 112, 'shipping_city', 3, 0),
	(183, 112, 'confirmed', 2, 0),
	(184, 112, 'created_at', 7, 0),
	(185, 112, 'confirmed_at', 7, 0),
	(186, 112, 'token', 3, 0),
	(187, 112, 'gateway', 3, 0),
	(188, 112, 'gateway_token', 3, 0),
	(189, 112, 'client_id', 3, 0),
	(190, 112, 'payer_id', 3, 0),
	(191, 112, 'error', 2, 0),
	(192, 112, 'deleted', 2, 0),
	(193, 112, 'order_mail', 2, 0),
	(194, 112, 'delivery', 3, 0),
	(195, 112, 'iban', 3, 0),
	(196, 112, 'bic', 3, 0),
	(197, 112, 'owner', 3, 0),
	(198, 112, 'mandat_ref_date', 3, 0),
	(199, 113, 'user_id', 2, 0),
	(200, 113, 'checkout_shipping_id', 2, 0),
	(201, 114, 'country', 3, 0),
	(202, 114, 'street', 3, 0),
	(203, 114, 'postal', 3, 0),
	(204, 114, 'city', 3, 0),
	...
	(207, 115, 'postal', 3, 0),
	(208, 115, 'city', 3, 0),
	(209, 106, 'category', 103, 0),
	(210, 106, 'manufacturer_id', 2, 0),
	(211, 116, 'name', 3, 0),
	(212, 116, 'slug', 3, 0),
	(213, 106, 'agio', 2, 0),
	(214, 102, 'KeyBeschreibung', 3, 0),
	(215, 102, 'deleted', 2, 0),
	(216, 102, 'parent', 103, 0),
	(217, 106, 'enabled', 2, 0),
	(218, 117, 'unit_id', 2, 0),
	(219, 117, 'name', 3, 0),
	(220, 117, 'deleted', 2, 0),
	(221, 118, 'manufacturer_id', 2, 0),
	(222, 118, 'name', 3, 0),
	(223, 118, 'country', 3, 0),
	(224, 118, 'postal', 3, 0),
	(225, 118, 'city', 3, 0),
	(226, 118, 'street', 3, 0),
	(227, 118, 'street_number', 3, 0),
	(228, 118, 'deleted', 2, 0),
	(229, 118, 'user', 2, 0),
	(230, 119, 'supplier_id', 2, 0),
	(231, 119, 'name', 3, 0),
	(232, 119, 'country', 3, 0),
	(233, 119, 'postal', 3, 0),
	(234, 119, 'city', 3, 0),
	(235, 119, 'street', 3, 0),
	(236, 119, 'street_number', 3, 0),
	(237, 119, 'deleted', 2, 0),
	(238, 119, 'user', 2, 0),
	(239, 120, 'warehouse_id', 2, 0),
	(240, 120, 'name', 3, 0),
	(241, 120, 'deleted', 2, 0),
	(242, 120, 'user', 2, 0),
	(243, 106, 'deliverable', 2, 0),
	(244, 106, 'top_offer', 2, 0),
	(245, 106, 'oversaleable', 2, 0),
	(246, 106, 'is_new', 2, 0),
	(247, 106, 'unit_id', 2, 0),
	(248, 106, 'weight', 2, 0),
	(250, 106, 'pack_unit', 3, 0),
	(251, 106, 'han', 3, 0),
	(252, 106, 'supplier_id', 2, 0),
	(253, 106, 'supplier_ek', 2, 0),
	(254, 106, 'supplier_tax', 2, 0),
	(255, 106, 'warehouse_id', 2, 0),
	(256, 106, 'weight_unit', 3, 0),
	(257, 121, 'tax_id', 2, 0),
	(258, 121, 'tax', 2, 0),
	(259, 121, 'deleted', 2, 0),
	(260, 121, 'user', 2, 0),
	(261, 118, 'slug', 3, 0),
	(262, 112, 'shipping_gender', 3, 0),
	(263, 112, 'shipping_name', 3, 0),
	(264, 112, 'shipping_prename', 3, 0),
	(265, 115, 'gender', 3, 0),
	(266, 115, 'name', 3, 0),
	(267, 115, 'prename', 3, 0),
	(268, 112, 'delivered', 2, 0),
	(269, 112, 'articles', 108, 0),
	(270, 112, 'total', 102, 0),
	(271, 112, 'delivery_costs', 102, 0),
	(272, 112, 'price_total', 102, 0),
	(278, 122, 'folder_id', 2, 0),
	(279, 122, 'folder', 3, 0),
	(280, 123, 'slug', 3, 0),
	(281, 123, 'breadcrumb', 3, 0),
	(282, 106, 'manufacturer_slug', 103, 0),
	(283, 106, 'search_result', 102, 0),
	(285, 124, 'search_type', 3, 0),
	(286, 124, 'hashed_term', 3, 0),
	(287, 125, 'search_result_id', 2, 0),
	(288, 125, 'model', 3, 0),
	(289, 125, 'model_id', 2, 0),
	(290, 125, 'clicked', 2, 0),
	(291, 106, 'search_rank', 102, 0),
	(292, 106, 'deleted', 2, 0),
	(294, 102, 'user', 2, 0),
	(295, 117, 'user', 2, 0),
	(296, 106, 'category_slug', 103, 0),
	(297, 112, 'processing', 2, 0),
	(298, 112, 'paid', 2, 0),
	(299, 112, 'done', 2, 0),
	(300, 126, 'article_id', 2, 0),
	(301, 126, 'gateway_id', 2, 0),
	(302, 127, 'gateway_id', 2, 0),
	(303, 127, 'gateway_name', 3, 0),
	(304, 106, 'payment_gateways', 108, 0),
	(305, 126, 'enabled', 2, 0),
	(307, 127, 'checkout_name', 3, 0),
	(308, 127, 'prefix', 3, 0),
	(309, 108, 'deliverable', 2, 0),
	(310, 108, 'available', 2, 0),
	(311, 108, 'enabled', 2, 0),
	(312, 106, 'special_prices', 108, 0),
	(313, 128, 'price_netto', 2, 0),
	(314, 128, 'price_type', 2, 0),
	(315, 128, 'price_enabled', 2, 0),
	(316, 129, 'name', 3, 0),
	...
	(322, 130, 'message', 3, 1),
	(323, 131, 'group_id', 2, 0),
	(324, 131, 'group_name', 3, 1),
	(325, 131, 'deleted', 2, 0),
	(326, 130, 'response_code', 3, 0);
...
-- Exportiere Daten aus Tabelle core.page_content: ~0 rows (ungefähr)
...
-- Exportiere Daten aus Tabelle core.products: ~0 rows (ungefähr)
...
-- Exportiere Daten aus Tabelle core.routes: ~89 rows (ungefähr)
DELETE FROM `routes`;
...
INSERT INTO `routes` (`ID`, `route`, `scope_id`, `layout`, `title`, `force`, `enabled`, `deleted`, `customizable`, `crawlable`, `seo_description`, `seo_keywords`, `seo_frequency`, `seo_priority`, `updated_at`) VALUES
	...
	(4, '/admin/shopmanagement', 1, 'admin-page', 'np | Artikelverwaltung', 0, 1, 0, 0, 0, '', '', 4, 5, '2017-03-05 13:04:50'),
	...
	(107, '/admin/*', 1, 'admin', 'np | Administration', 0, 1, 0, 0, 0, '', '', 4, 5, '2017-02-22 13:16:21'),
	(108, '/admin/shopmanagement/variations', 1, 'admin-page', 'np | Artikelverwaltung > Variationen', 1, 1, 0, 0, 0, '', '', 4, 5, '2017-02-22 13:16:59'),
	(109, '/admin/shopmanagement/variations/*', 1, 'admin-page', 'np | Artikelverwaltung > Variationen', 1, 1, 0, 0, 0, '', '', 4, 5, '2017-02-22 13:16:59'),
	(110, '/admin/shopmanagement/variations/groups', 1, 'admin-page', 'np | Artikelverwaltung > Variationen > Gruppen', 1, 1, 0, 0, 0, '', '', 4, 5, '2017-02-22 13:16:59'),
	(111, '/admin/shopmanagement/variations/groups/*', 1, 'admin-page', 'np | Artikelverwaltung > Variationen > Gruppen', 1, 1, 0, 0, 0, '', '', 4, 5, '2017-02-22 13:16:59'),
	(112, '/admin/shopmanagement/variations/group/*', 1, 'admin-page', 'np | Artikelverwaltung > Variationen > Gruppe', 1, 1, 0, 0, 0, '', '', 4, 5, '2017-03-10 14:57:35'),
	(113, '/admin/shopmanagement/variations/group', 1, 'admin-page', 'np | Artikelverwaltung > Variationen > Gruppe', 1, 1, 0, 0, 0, '', '', 4, 5, '2017-03-10 14:57:36');
...
-- Exportiere Daten aus Tabelle core.route_page_content: ~0 rows (ungefähr)
...
-- Exportiere Daten aus Tabelle core.taxes: ~0 rows (ungefähr)
DELETE FROM `taxes`;
/*!40000 ALTER TABLE `taxes` DISABLE KEYS */;
/*!40000 ALTER TABLE `taxes` ENABLE KEYS */;


-- Exportiere Struktur von Tabelle core.translations
...
-- Exportiere Daten aus Tabelle core.translations: ~19 rows (ungefähr)
...
INSERT INTO `translations` (`ID`, `lang_code`, `definition_id`, `row_id`, `content`) VALUES
	...
	(17, 'en', 322, 17, 'Request error: forbidden'),
	(18, 'en', 322, 18, 'Session lost.'),
	(19, 'en', 322, 19, 'Unknown model attribute.');
...
-- Exportiere Daten aus Tabelle core.user_billings: ~0 rows (ungefähr)
...
-- Exportiere Daten aus Tabelle core.user_companies: ~0 rows (ungefähr)
...
-- Exportiere Daten aus Tabelle core.user_orders: ~0 rows (ungefähr)
...
-- Exportiere Daten aus Tabelle core.user_shippings: ~0 rows (ungefähr)
