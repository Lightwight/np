...
np.controller.extend ('AdminProductsOverviewSearchController', (function () {
    function getFilter () {
        var search, map;
        ...
        events: {
            search: function (view) {
                ...
                if (search.length > 0) {
                    ...
                    np.routeTo ('#/admin/shopmanagement/articles/1'+sortBy+sortOrder+'/'+search+filter);
                }
            },
            ...
            clearSearch: function () {
                ...
                np.model.Products.flush ();
                np.routeTo ('#/admin/shopmanagement/articles/1'+sortBy+sortOrder);
            }
        }
    };
})());