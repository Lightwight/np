np.controller.extend ('AdminArticleWarehouseAddController', (function () {
    var model, retModel, renderView, anchor;
    
    model       = 'Article_warehouses';
    retModel    = 'AdminArticleWarehouse';
    renderView  = 'AdminArticleWarehouseOverviewView';
    anchor      = '#admin-article-warehouse-add';
    ...
    return {
        view:   'AdminArticleWarehouseAddView',
        model:  function () {
            var _def, _row;
