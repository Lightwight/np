...
np.controller.extend ('AdminArticleWarehouseOverviewController', (function () {
    var model, retModel;
    
    retModel    = 'AdminArticleWarehouse';
    model       = 'Article_warehouses';
    
    return {
        view:   'AdminArticleWarehouseOverviewView',
        model:  function () {
            var retVal;
        ...
        events: {
            removeRow: function () {
                ...
                title       = 'Lager entfernen';
                message     = 'Soll das Lager wirklich entfernt werden?';
