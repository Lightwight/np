...
np.controller.extend ('AdminArticleUnitsOverviewSearchController', (function () {
    var model, returnModel, route, defaultSort;
    
    model       = 'Article_units';
    returnModel = 'AdminArticleUnitsSearch';
    route       = '#/admin/shopmanagement/articleunits/1';
    defaultSort = 'name';
    
    return {
        view:   'AdminArticleUnitsOverviewSearchView',
        model:  function () {
            var retVal;
