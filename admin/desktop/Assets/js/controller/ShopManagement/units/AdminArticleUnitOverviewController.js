...
np.controller.extend ('AdminArticleUnitOverviewController', (function () {
    var model, retModel;
    ...
    return {
        view:   'AdminArticleUnitOverviewView',
        model:  function () {
            var retVal;
        ...
        events: {
            removeRow: function () {
                ...
                title       = 'Artikeleinheit entfernen';
                message     = 'Soll die Artikeleinheit wirklich entfernt werden?';
