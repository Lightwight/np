...
np.controller.extend ('AdminArticleTaxOverviewController', (function () {
    var model, retModel;
    ...
    return {
        view:   'AdminArticleTaxOverviewView',
        model:  function () {
            var retVal;
        ...
        events: {
            removeRow: function () {
                ...
                title       = 'Steuersatz entfernen';
                message     = 'Soll der Steuersatz wirklich entfernt werden?';
