...
np.controller.extend ('AdminArticleSuppliersOverviewSearchController', (function () {
    var model, returnModel, route, defaultSort;
    
    model       = 'Article_suppliers';
    returnModel = 'AdminArticleSuppliersSearch';
    route       = '#/admin/shopmanagement/suppliers/1';
    defaultSort = 'name';
    
    return {
        view:   'AdminArticleSuppliersOverviewSearchView',
        model:  function () {
            var retVal;
