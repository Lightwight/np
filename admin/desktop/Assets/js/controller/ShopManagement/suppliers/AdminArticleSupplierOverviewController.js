...
np.controller.extend ('AdminArticleSupplierOverviewController', (function () {
    var model, retModel;
    ...
    return {
        view:   'AdminArticleSupplierOverviewView',
        model:  function () {
            var retVal;
        ...
        events: {
            removeRow: function () {
                ...
                message     = 'Soll der Lieferant wirklich entfernt werden?';
