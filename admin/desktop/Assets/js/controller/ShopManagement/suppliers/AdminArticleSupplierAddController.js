np.controller.extend ('AdminArticleSupplierAddController', (function () {
    var model, retModel, renderView, anchor;
    
    model       = 'Article_suppliers';
    retModel    = 'AdminArticleSupplier';
    renderView  = 'AdminArticleSupplierOverviewView';
    anchor      = '#admin-article-supplier-add';
    ...
    return {
        view:   'AdminArticleSupplierAddView',
        model:  function () {
            var _def, _row;
