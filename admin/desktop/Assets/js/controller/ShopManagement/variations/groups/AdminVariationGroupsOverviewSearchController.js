...
np.controller.extend ('AdminVariationGroupsOverviewSearchController', {
    view:   'AdminVariationGroupsOverviewSearchView',
    model:  function () {
        return {
            AdminVariationGroupsSearch: {
                id:         -1,
    ...
    events: {
        search: function (view) {
            ...
            if (search.length > 0) {
                ...
                np.routeTo ('#/admin/shopmanagement/variations/groups/1'+sortBy+sortOrder+'/'+search);
            }
        },
        ...
        clearSearch: function () {
            ...
            np.model.Users.flush ();
            np.routeTo ('#/admin/shopmanagement/variations/groups/1'+sortBy+sortOrder);
        }
    }
});