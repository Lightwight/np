...
np.controller.extend ('AdminArticleManufacturersOverviewSearchController', (function () {
    var model, returnModel, route, defaultSort;
    
    model       = 'Article_manufacturers';
    returnModel = 'AdminArticleManufacturersSearch';
    route       = '#/admin/shopmanagement/manufacturers/1';
    defaultSort = 'name';
    
    return {
        view:   'AdminArticleManufacturersOverviewSearchView',
        model:  function () {
            var retVal;
