...
np.controller.extend ('AdminUsersOverviewSearchController', {
    view:   'AdminUsersOverviewSearchView',
    model:  function () {
        return {
            AdminUsersSearch: {
                id:         -1,
    ...
    events: {
        search: function (view) {
            ...
            if (search.length > 0) {
                ...
                np.routeTo ('#/admin/usermanagement/users/1'+sortBy+sortOrder+'/'+search);
            }
        },
        ...
        clearSearch: function () {
            ...
            np.model.Users.flush ();
            np.routeTo ('#/admin/usermanagement/users/1'+sortBy+sortOrder);
        }
    }
});