...
np.controller.extend ('AdminModelsOverviewSortableController', {
    view:   'AdminModelsOverviewSortableView',
    model:  function () {
        return {
            AdminModelSortable: {
                id:         -1,
    ...
    events: {
        sortByID: function () {
            ...
            np.model.Models.flush ();
            np.routeTo ('#/admin/modelmanagement/'+np.pagination.getPage ()+'/id/'+sortOrder+'/'+search);
        },
        ...
        sortByName: function () {
            ...
            np.model.Models.flush ();
            np.routeTo ('#/admin/modelmanagement/'+np.pagination.getPage ()+'/name/'+sortOrder+'/'+search);
        }
    }
});