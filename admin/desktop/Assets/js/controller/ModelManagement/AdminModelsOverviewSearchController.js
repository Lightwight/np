...
np.controller.extend ('AdminModelsOverviewSearchController', {
    view:   'AdminModelsOverviewSearchView',
    model:  function () {
    ...
    events: {
        search: function (view) {
            ...
            if (search.length > 0) {
                ...
                np.routeTo ('#/admin/modelmanagement/1'+sortBy+sortOrder+'/'+search);
            }
        },
        ...
        clearSearch: function () {
            ...
            np.model.Models.flush ();
            np.routeTo ('#/admin/modelmanagement/1'+sortBy+sortOrder);
        }
    }
});