...
np.controller.extend ('AdminScopesOverviewSearchController', {
    view:   'AdminScopesOverviewSearchView',
    model:  function () {
    ...
    events: {
        search: function (view) {
            ...
            if (search.length > 0) {
                ...
                np.routeTo ('#/admin/routesmanagement/scopes/1'+sortBy+sortOrder+'/'+search);
            }
        },
        ...
        clearSearch: function () {
            ...
            np.model.Route_scopes.flush ();
            np.routeTo ('#/admin/routesmanagement/scopes/1'+sortBy+sortOrder);
        }
    }
});