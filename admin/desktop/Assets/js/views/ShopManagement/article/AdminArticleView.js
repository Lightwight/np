...
np.view.extend ('AdminArticleView', (function () {
...
//        }, 0);
//
//        menuScene       = new ScrollMagic.Scene ({triggerElement: '.main-content', triggerHook: "onLeave", offset: -170, duration: 360})
//        .setTween (menuTween)
//        .addTo (smController);
    }
    ...
    return {
        ...
        windowSize: function () {
            ...
            $(window).scrollTop (0);
        }.observes ('window.resize').on ('change'),
