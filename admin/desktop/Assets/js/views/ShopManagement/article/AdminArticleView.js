...
np.view.extend ('AdminArticleView', {
    ...
    savingArticleGlobalSettings: function (model) {
        if (model.get ('savingArticleGlobalSettings')) {
            this.addClass ('show');
        } else {
            this.removeClass ('show');
        }
    }.observes ('savingArticleGlobalSettings').on ('change'),
    
    disableSaveArticleGlobalSettings: function (model) {
        if (model.get ('savingArticleGlobalSettings')) {
            this.addClass ('disabled');
        } else {
            this.removeClass ('disabled');
    ...
    savingArticleSettings: function (model) {
        if (model.get ('savingArticleSettings')) {
            this.addClass ('show');
        } else {
            this.removeClass ('show');
        }
    }.observes ('savingArticleSettings').on ('change'),
    
    savingArticlePayments: function (model) {
        if (model.get ('savingArticlePayments')) {
            this.addClass ('show');
        } else {
            this.removeClass ('show');
        }
    }.observes ('savingArticlePayments').on ('change'),
    
    disableSaveArticleSettings: function (model) {
        if (model.get ('savingArticleSettings')) {
            this.addClass ('disabled');
        } else {
            this.removeClass ('disabled');
    ...
    disableSaveArticlePayments: function (model) {
        if (model.get ('savingArticlePayments')) {
            this.addClass ('disabled');
        } else {
            this.removeClass ('disabled');
    ...
    savingManufacturerSettings: function (model) {
        if (model.get ('savingManufacturerSettings')) {
            this.addClass ('show');
        } else {
            this.removeClass ('show');
        }
    }.observes ('savingManufacturerSettings').on ('change'),
    
    savingSupplierSettings: function (model) {
        if (model.get ('savingSupplierSettings')) {
            this.addClass ('show');
        } else {
            this.removeClass ('show');
        }
    }.observes ('savingSupplierSettings').on ('change'),

    disableSaveSupplierSettings: function (model) {
        if (model.get ('savingSupplierSettings')) {
            this.addClass ('disabled');
        } else {
            this.removeClass ('disabled');
    ...
    savingWarehouseSettings: function (model) {
        if (model.get ('savingWarehouseSettings')) {
            this.addClass ('show');
        } else {
            this.removeClass ('show');
        }
    }.observes ('savingWarehouseSettings').on ('change'),
    
    disableSaveWarehouseSettings: function (model) {
        if (model.get ('savingWarehouseSettings')) {
            this.addClass ('disabled');
        } else {
            this.removeClass ('disabled');
