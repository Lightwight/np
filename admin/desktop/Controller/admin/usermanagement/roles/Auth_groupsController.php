...
class Auth_groupsController extends ControllerHelper implements ControllerInterface 
{
    ...
    public function getModel (\Model $model, $params) 
    {
        ...
        $sort       = isset ($params[1]) ? $this->escape_string ($params[1]) : 'group';
        ...
        {
            return $model->paginate (10, $page)->orderBy ($sort, $sortOrder)->findLike ('ID', $search)->orFindLike ('group', $search)->result ();
        }
    }
