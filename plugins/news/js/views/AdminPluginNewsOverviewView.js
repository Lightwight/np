...
np.view.extend ('AdminPluginNewsOverviewView', {
    ...
    showAddNews: function (model) {
        if (model.get ('addNews')) {
            this.addClass ('fadeIn');
        } else {
            this.removeClass ('fadeIn');
        }
    }.observes ('addNews').on ('change'),
    ...
    disableSaveNewNews: function (model) {
        if (model.get ('saving')) {
    ...
    disableSaveNews: function (model) {
        if (model.get ('saving')) {
            this.addClass ('disabled');
        } else {
            this.removeClass ('disabled');
