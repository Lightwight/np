...
np.view.extend ('AdminPluginSliderView', {
    ...
    showAddSlide: function (model) {
        if (model.get ('addSlide')) {
            this.addClass ('fadeIn');
        } else {
            this.removeClass ('fadeIn');
        }
    }.observes ('addSlide').on ('change'),
    ...
    disableSaveNewSlide: function (model) {
        if (model.get ('saving')) {
    ...
    disableSaveSlides: function (model) {
        if (model.get ('saving')) {
            this.addClass ('disabled');
        } else {
            this.removeClass ('disabled');
